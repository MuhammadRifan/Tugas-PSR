<div class="panel panel-primary">
    <div class="panel-heading">
        <a href="<?= base_url() ?>Obat/homePage" class="btn btn-info">Back</a> Cart
    </div>
    <div class="panel-body">
                ...
                ?>
                    <tr>
                        ...
                        <td style="width: 220px">
                            <button type="button"class="btn btn-primary btn-sm"data-toggle="modal"data-target="<?=$x?>">
                              Ubah
                            </button>
                            <a href="<?= base_url() ?>Obat/actdel/<?= $id ?>" class="btn btn-danger btn-sm">Hapus</a>
                        </td>
                    </tr>
                <?php
                    }
        ...
        <?php foreach ($db as $key) {
            $id = $key->id;
            $x = "modal fade bs-example-modal-sm-$id";
            $z = 'autocomplete="off" required';
        ?>
            <div class="<?= $x ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" action="<?=base_url()?>Obat/ubahCart/<?=$id?>" method="post">
                                <p class="text-center">
                                    <?= $key->nama ?>
                                        &nbsp X &nbsp
